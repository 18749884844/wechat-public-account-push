...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx51fcf61bc2f35084',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'be0646cfb627bbc3afcb8b122a5bedeb',
  ...
  USERS: [
    {
      ...
      id: 'o-vMa6zJfdW_Btvh9TmPGizXVbjQ',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'L5iTMlHgH1FOiSpb3fIG3gkM5imLzSn-cgiw4uhgn6U',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '兰考',
